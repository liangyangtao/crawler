 ...
 * @version V1.0
 */
public class Notice2LinkByIdApp {
	...
	public static void main(String[] args) {
		...
		try {
			...
			if (file.exists()) {
				...
				while ((line = br.readLine()) != null) {
					noticeids.add(Long.parseLong(line));
				}
				br.close();
				reader.close();
			}
		...
		for (Long id : noticeids) {
			...
			try {
				NeeqCompanyNotice neeqCompanyNotice = neeqCompanyNoticeReader.readNeeqCompanyNoticesById(id);
				if (neeqCompanyNotice != null) {
